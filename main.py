...
"""
def create_pruned_dataset(input_source_file, output_source_file):
    # Step 1: Create pruned dataset with rare classes
    create_pruned_dataset_rare_classes(input_file=input_source_file, output_file='output_rare.json', threshold=100)

    # Step 2: Create pruned dataset with common classes
    create_pruned_dataset_common_classes(original_file=input_source_file, input_file='output_rare.json', output_file='output_common.json', threshold=100)
...
if __name__ == '__main__':
    ...
    if args.create_pruned_dataset and args.input_source_file and args.output_source_file:
        create_pruned_dataset(args.input_source_file, args.output_source_file)
